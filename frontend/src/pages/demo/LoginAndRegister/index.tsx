...
// components
import HtmlLoginPage from './Login/LoginHtml/htmlLoginPage';
      ...
      <div className="shell">
        ...
        <div className="switch" id="switch-cnt">
          ...
          <div className="switch_container" id="switch-c1">
            ...
            <button className="switch_button button switch-btn" id="switch_register">切换注册</button>
          </div>
          ...
          <div className="switch_container is-hidden" id="switch-c2">
            ...
            <button className="switch_button button switch-btn" id="switch_login">切换登录</button>
          </div>
        </div>
      </div>
    </Fragment>
